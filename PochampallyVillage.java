...
public class PochampallyVillage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pochampally_village);
        gi1 = findViewById(R.id.gi1);
        Picasso.get().load("https://images.indianexpress.com/2021/09/kongthong-1200.jpg").placeholder(R.drawable.appbg).into(gi1);
        gi2 = findViewById(R.id.gi2);
        Picasso.get().load("https://scontent.fhyd2-1.fna.fbcdn.net/v/t1.6435-9/123688073_1027045977797951_5222789908981326471_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=kyHoaQEUttAAX8mRYge&_nc_ht=scontent.fhyd2-1.fna&oh=00_AT_ggns98y9jTTKBN-CROnNBPhQ33U1FayzgBR1KOGrceQ&oe=61E0FCB5").placeholder(R.drawable.appbg).into(gi2);
    ...
    public void on(View v) {
        Uri webpage = Uri.parse("https://goo.gl/maps/QQRDcx5WX6mAYBfZA");
        Intent intent = new Intent(Intent.ACTION_VIEW, webpage);
        startActivity(intent);

    }
    public void onr(View v) {
        Uri webpage = Uri.parse("https://goo.gl/maps/MZfSLep6EdMBQzMs8");
        Intent intent = new Intent(Intent.ACTION_VIEW, webpage);
        startActivity(intent);
